...
- [Instalación del Proyecto](#-instalación-del-proyecto)
  - [Opción 1: Laravel Herd (Recomendado)](#opción-1-laravel-herd-recomendado)
  - [Opción 2: XAMPP](#opción-2-xampp)
  - [Opción 3: Artisan](#opción-3-artisan)
- [Configuración de Node.js](#️-configuración-de-nodejs)
- [Base de Datos PostgreSQL](#-base-de-datos-postgresql)
- [Configuración Final](#️-configuración-final)
...
Descarga e instala desde: [https://herd.laravel.com/windows](https://herd.laravel.com/windows)
...
1. Abre el panel de **Herd**
2. Ve a la sección **Sites**
3. Selecciona **"Link existing project"** y elige la carpeta raíz del proyecto
4. Accede desde tu navegador usando la URL proporcionada (ej: `http://frontlaravel.test/`)
...
Descarga desde: [https://www.apachefriends.org/download.html](https://www.apachefriends.org/download.html)
...
1. Dirígete a la carpeta `backNode`
2. Abre el archivo `dataBaseCredentials.js`
...
1. Abre `backNode/index.js`
2. En la línea 8, modifica la variable `origin` para incluir la URL de tu frontend:
